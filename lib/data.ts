export const projects = [
  {
    id: "mrittrikar-ghran",
    title: "Mrittrikar Ghran",
    subtitle: "Tree Distribution Initiative",
  ...
  {
    id: "public-help-eid",
    title: "Eid Gift Drive",
    subtitle: "Spreading Joy on Eid",
    category: "Relief",
    icon: "🎁",
    color: "#d97706",
    ...
    fullDesc: `Eid is a time of joy and celebration, but for many families in Bangladesh, the festival season brings financial stress rather than happiness. Our Eid Gift Drive ensures that no child goes without a gift and no family celebrates without proper food.\n\nEvery year before Eid-ul-Fitr and Eid-ul-Adha, our volunteers collect donations and personally deliver gift packages to identified families in need. The packages include new clothing for children, food items, and small toys.\n\nWe work with local union councils and community leaders to identify the most vulnerable families and ensure our assistance reaches those who need it most.`,
    activities: [
  ...
  {
    id: "winter-cloth-drive",
    title: "Winter Warmth",
    subtitle: "Clothing Distribution Campaign",
    category: "Relief",
    icon: "🧥",
    color: "#7c3aed",
    ...
    activities: [
      ...
      "Street dweller outreach",
      "Remote village programs",
  ...
  },
  {
    id: "self-reliant",
    title: "Self-Reliant",
    subtitle: "Sewing Machine Distribution",
    category: "Livelihood",
    icon: "🪡",
    color: "#db2777",
  ...
  {
    id: "public-health-camp",
    title: "Public Health Camp",
    subtitle: "Free Medical Services",
    category: "Health",
    icon: "🏥",
    color: "#0891b2",
  ...
  },
  {
    ...
    subtitle: "Scholarship & Book Distribution",
    category: "Education",
    icon: "📚",
    color: "#065f46",
    ...
    status: "Ongoing",
    shortDesc: "Supporting meritorious but financially constrained students with scholarships, books, and educational materials.",
    fullDesc: `Education is the most powerful tool for breaking the cycle of poverty. Our Education First program identifies meritorious students from low-income families who are at risk of dropping out due to financial constraints, and provides them with scholarships, books, stationery, and educational support.\n\nWe work with schools and madrasas across the country to identify deserving students. Scholarship recipients receive monthly stipends to cover school fees and commuting costs, while all beneficiaries receive full sets of textbooks and educational supplies at the start of each academic year.\n\nTo date, we have supported over 800 students, many of whom have gone on to complete their SSC, HSC, and even university degrees.`,
    activities: [
      "Monthly scholarship stipends",
...
export const faqs = [
  {
    q: "What is AdDReSSBANGLADESH?",
    a: "AdDReSSBANGLADESH is a registered non-profit society in Bangladesh working to empower communities through education, health, livelihood, environment, and relief programs. We believe in building self-sufficient communities through sustainable development."
  },
  {
    q: "How can I donate to support your projects?",
    a: "You can donate via bKash, bank transfer, or international payment gateways. Click the 'Donate Us' button in the navigation bar and follow the simple steps. All donations are tax-exempt under Bangladesh NGO regulations."
  },
  {
    q: "Can I volunteer with AdDReSSBANGLADESH?",
    a: "Yes! We warmly welcome volunteers. Please contact us via email or phone, or fill out the contact form. We have regular volunteer drives especially during Eid, winter, and health camp seasons."
  },
  {
    q: "How do you select beneficiaries for your programs?",
    a: "We work with local union councils, community leaders, and grassroots networks to identify the most vulnerable families. Priority is given to women, children, the elderly, persons with disabilities, and extreme poor households."
  },
  {
    q: "Is AdDReSSBANGLADESH a registered organization?",
    a: "Yes, AdDReSSBANGLADESH is registered as a society in Bangladesh. We operate under all required government permissions and comply fully with section 20 and other relevant provisions of the Societies Registration Act."
  },
  {
...
export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    contact: "Contact",
    donate: "Donate Us",
    heroTitle: "Serving Humanity, Building Bangladesh",
    heroSub: "AdDReSSBANGLADESH works with communities to create self-sufficient, educated, and healthy societies through sustainable development programs.",
    exploreProjects: "Explore Projects",
    learnMore: "Learn More",
    ourProjects: "Our Projects",
    projectsSub: "Transforming communities through targeted, sustainable action",
    ourImpact: "Our Impact",
    impactSub: "Numbers that tell our story of compassion and change",
    whatTheySay: "What They Say",
    testimonialSub: "Real voices from the people we serve",
    faqTitle: "Frequently Asked Questions",
    faqSub: "Everything you need to know about AdDReSSBANGLADESH",
    galleryTitle: "Our Gallery",
    gallerySub: "Glimpses of our work across Bangladesh",
    contactTitle: "Get In Touch",
    contactSub: "We'd love to hear from you",
    aboutTitle: "About AdDReSSBANGLADESH",
  },
  bn: {
    home: "হোম",
    ...
    contact: "যোগাযোগ",
    donate: "ডোনেট করুন",
    heroTitle: "মানবতার সেবায়, বাংলাদেশ গড়ায়",
    heroSub: "অ্যাড্রেসবাংলাদেশ টেকসই উন্নয়ন কর্মসূচির মাধ্যমে স্বনির্ভর, শিক্ষিত ও সুস্থ সমাজ গড়তে কাজ করে।",
    exploreProjects: "প্রকল্প দেখুন",
    learnMore: "আরো জানুন",
    ourProjects: "আমাদের প্রকল্প",
    projectsSub: "লক্ষ্যভিত্তিক, টেকসই কর্মের মাধ্যমে সম্প্রদায় রূপান্তর",
    ourImpact: "আমাদের প্রভাব",
    impactSub: "করুণা ও পরিবর্তনের গল্প বলে এই সংখ্যাগুলো",
    whatTheySay: "তারা যা বলেন",
    testimonialSub: "আমরা যাদের সেবা করি তাদের সত্যিকারের কণ্ঠস্বর",
    faqTitle: "সাধারণ জিজ্ঞাসা",
    faqSub: "অ্যাড্রেসবাংলাদেশ সম্পর্কে যা জানতে চান",
    galleryTitle: "আমাদের গ্যালারি",
    gallerySub: "বাংলাদেশ জুড়ে আমাদের কাজের ঝলক",
    contactTitle: "যোগাযোগ করুন",
    contactSub: "আমরা আপনার সাথে কথা বলতে আগ্রহী",
    aboutTitle: "অ্যাড্রেসবাংলাদেশ সম্পর্কে",
  }
};
