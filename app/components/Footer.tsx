            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-16 pb-8">
              ...
              <div>
                ...
                <div className="text-xs text-emerald-300">Serving Humanity</div>
                        ...
                        <p className="text-sm text-green-200 leading-relaxed mb-5 mt-5">
                            Building self-sufficient communities through
                        ...
                        <div className="flex gap-3">
                            {[FaFacebook].map((Icon, i) => (
                                <a
                                    key={i}
                                    href="https://www.facebook.com/people/%E0%A6%85%E0%A7%8D%E0%A6%AF%E0%A6%BE%E0%A6%A1%E0%A7%8D%E0%A6%B0%E0%A7%87%E0%A6%B8-%E0%A6%AC%E0%A6%BE%E0%A6%82%E0%A6%B2%E0%A6%BE%E0%A6%A6%E0%A7%87%E0%A6%B6/100064905875116/"
                                    className="w-8 h-8 rounded-lg flex items-center justify-center text-green-200 hover:text-white transition-all hover:scale-110"
                                    style={{
                        ...
                        <div className="flex flex-col gap-2">
                            {[
                                ...
                                <Link
                                    key={link.href}
                                    href={link.href}
                                    className="text-sm text-green-200 hover:text-white transition-colors hover:translate-x-1 inline-block"
                                >
                                    → {link.label}
                                </Link>
                            ))}
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex items-center gap-3 text-green-200">
                                ...
                                />
                                <a
                                    href="mailto:info@addressbangladesh.org"
                                    className="text-sm hover:text-white transition-colors"
                                >
                                    addressbangladeshngo@gmail.com
                                </a>
                            </div>
                            <div className="flex items-center gap-3 text-green-200">
                                <MdPhone
                                    ...
                                    className="flex-shrink-0 text-yellow-400"
                                />
                                <span className="text-sm">+880 1759733296</span>
                            </div>
                        </div>
                ...
                >
                    <p className="text-xs text-green-300">
                        © {new Date().getFullYear()} AdDReSSBANGLADESH. All
                        rights reserved.
                    </p>
